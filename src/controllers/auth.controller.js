...
exports.activateAccount = async (req, res) => {
  try {
    ...
    if (service.type === 'SUBSCRIPTION') {
      ...
      const initialUnitsClaimed = isCaseB ? 2 : 1; // both methods consume units from the annual 12
      ...
      const membership = await Membership.create({
        ...
        unitsClaimed: initialUnitsClaimed,
      ...
      if (!isCaseB) {
        ...
        // Mark this 2nd unit as claimed in membership
        membership.unitsClaimed = 2;
